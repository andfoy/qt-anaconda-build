...
( startgroup "Installing a fresh version of Miniconda" ) 2> /dev/null

MINIFORGE_URL="https://repo.anaconda.com/miniconda"
MINIFORGE_FILE="Miniconda3-latest-MacOSX-$(uname -m).sh"
...
source .scripts/run_conda_forge_build_setup.sh
